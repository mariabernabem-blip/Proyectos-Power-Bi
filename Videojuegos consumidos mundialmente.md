...
## Objetivos
En este proyecto de nivel básico de Power Bi, voy a llevar a cabo un reporte interacivo que nos permita analizas las ventas de millones de copias de videojuegos a nivel mundial.
...
Un Gráfico de Anillo (Dona) para ver el porcentaje de ventas por región.
...
Formato de Reporte: Se finaliza el proyecto aplicando mejoras de diseño:

Cambio del tema general del reporte.

Aplicación de formato (títulos, bordes, colores) a las visualizaciones usando la opción "Copiar formato".

Creación de un encabezado o banner con el título del reporte utilizando un cuadro de texto y una forma de rectángulo, aprendiendo a enviarlo al fondo para que los segmentadores queden encima.
