# Proyecto 2:
## El equipo directivo de Apol requiere conocer los indicadores de Beneficios ($) y de % Porcentaje respecto a Ingresos, para así poder medir el desempeño de los productos y regiones, para poder desarrollar estrategias.
...
Se aplican estilos y configuraciones de formato detalladas a los gráficos y tablas para mejorar la presentación (colores, títulos, ejes).
